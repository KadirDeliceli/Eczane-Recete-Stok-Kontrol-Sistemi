...
<body>
    <a href="zhastaneekle.php" class="btn">Hastane Ekle</a>

    <a href="index.php" class="btn">Ana Sayfa</a>
    <br>

    <div class="overlay"></div> <input type="text" id="arama" placeholder="Hastane Alan Numarası Giriniz..." onkeyup="filmAra()">
    ...
    <div class="film-container">
        ...
        $Sorgu = mysqli_query($VeritabaniBaglantisi, "call ecz_hastanelerhepsi()");
        if ($Sorgu) {
            echo "<div class='ilaclar-container'>";
            while ($Kayit = mysqli_fetch_assoc($Sorgu)) {
                echo "<div class='film' data-film-id='" . $Kayit["HastaneID"] . "'>";
                echo     "<p class='film-isim'><strong>Hastane Alan Numarası:</strong> " . $Kayit["HastaneID"] . "</p>";
                echo     "<p><strong>HastaneAdı:</strong> " . $Kayit["HastaneAdı"] . "</p>";
                echo     "<p><strong>Adres:</strong>" . $Kayit["Adres"] . "</p>";
                echo     "<p><strong>Telefon:</strong>" . $Kayit["Telefon"] . "</p>";
                echo     "<a href='zhastanesil.php?HastaneID=" . $Kayit["HastaneID"] . "'class='imdb-btn'>Hastaneyi Sil</a>";
                echo " ";
                echo     "<a href='zhastaneduzenle.php?HastaneID=" . $Kayit["HastaneID"] . "'class='imdb-btn'>Hastaneyi Düzenle</a>";
