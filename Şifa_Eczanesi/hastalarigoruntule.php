...
<body>
    <a href="hastaekle.php" class="btn">Hasta Ekle</a>

    <a href="index.php" class="btn">Ana Sayfa</a>
    <br>

    <div class="overlay"></div> <input type="text" id="arama" placeholder="Hasta TC Numarası Giriniz..." onkeyup="filmAra()">
    ...
    <div class="film-container">
        ...
        $Sorgu = mysqli_query($VeritabaniBaglantisi, "call ecz_hastalarhepsi()");
        if ($Sorgu) {
            echo "<div class='ilaclar-container'>";
            while ($Kayit = mysqli_fetch_assoc($Sorgu)) {
                echo "<div class='film' data-film-id='" . $Kayit["TC_KimlikNo"] . "'>";
                echo     "<p class='film-isim'><strong>Hasta TC Nummarsaı:</strong> " . $Kayit["TC_KimlikNo"] . "</p>";
                echo     "<p><strong>Adı:</strong> " . $Kayit["Adı"] . "</p>";
                echo     "<p><strong>Soyadı:</strong>" . $Kayit["Soyadı"] . "</p>";
                echo     "<p><strong>DoğumTarihi:</strong>" . $Kayit["DoğumTarihi"] . "</p>";
                ...
                echo     "<a href='hastasil.php?TC_KimlikNo=" . $Kayit["TC_KimlikNo"] . "'class='imdb-btn'>Hastayı Sil</a>";
                echo " ";
                echo     "<a href='hastaduzenle.php?TC_KimlikNo=" . $Kayit["TC_KimlikNo"] . "'class='imdb-btn'>Hastayı Düzenle</a>";
