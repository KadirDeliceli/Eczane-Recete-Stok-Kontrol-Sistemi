...
<body>
    <a href="receteekle.php" class="btn">reçete Ekle</a>
    ...
    <div class="film-container">
        ...
        $Sorgu = mysqli_query($VeritabaniBaglantisi, "call ecz_recetelerhepsi()");
        if ($Sorgu) {
            echo "<div class='ilaclar-container'>";
            while ($Kayit = mysqli_fetch_assoc($Sorgu)) {
                echo "<div class='film' data-film-id='" . $Kayit["ReceteID"] . "'>";
                ...
                echo     "<a href='recetedetay.php?ReceteID=" . $Kayit["ReceteID"] . "'class='imdb-btn'>Reçete Detayı</a>";
                /*
